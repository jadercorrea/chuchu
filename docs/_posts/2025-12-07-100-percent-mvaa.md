...
```yaml
- uses: gptcode-cloud/cli-action@v1
  with:
    command: 'ci'
    auto-fix: true
    min-coverage: 80
...
**Want to contribute?** [Check out the codebase →](https://github.com/gptcode-cloud/cli)

**Have questions?** [Open an issue →](https://github.com/gptcode-cloud/cli/issues)
